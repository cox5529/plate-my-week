...
export type EmployeeRoleLeaf<TContent, TProperty extends string> = EmployeeRoleBase & {
	'@type': 'EmployeeRole';
} & {
	[key in TProperty]: TContent;
};
/** A subclass of OrganizationRole used to describe employee relationships. */
export type EmployeeRole<TContent = never, TProperty extends string = never> = EmployeeRoleLeaf<
	TContent,
	TProperty
>;
...
export type LinkRoleLeaf<TContent, TProperty extends string> = LinkRoleBase & {
	'@type': 'LinkRole';
} & {
	[key in TProperty]: TContent;
};
/** A Role that represents a Web link, e.g. as expressed via the 'url' property. Its linkRelationship property can indicate URL-based and plain textual link types, e.g. those in IANA link registry or others such as 'amphtml'. This structure provides a placeholder where details from HTML's link element can be represented outside of HTML, e.g. in JSON-LD feeds. */
export type LinkRole<TContent = never, TProperty extends string = never> = LinkRoleLeaf<
	TContent,
	TProperty
>;
/**
...
export type OrganizationRoleLeaf<TContent, TProperty extends string> = OrganizationRoleBase & {
	'@type': 'OrganizationRole';
} & {
	[key in TProperty]: TContent;
};
/** A subclass of Role used to describe roles within organizations. */
export type OrganizationRole<TContent = never, TProperty extends string = never> =
...
export type PerformanceRoleLeaf<TContent, TProperty extends string> = PerformanceRoleBase & {
...
export type RoleLeaf<TContent, TProperty extends string> = RoleBase & {
	'@type': 'Role';
} & {
	[key in TProperty]: TContent;
};
 ...
 */
export type Role<TContent = never, TProperty extends string = never> =
...
interface ActionBase extends ThingBase {
	...
	target?: SchemaValue<EntryPoint | URL | IdReference>;
}
...
interface AudioObjectBase extends MediaObjectBase {
	...
	embeddedTextCaption?: SchemaValue<Text>;
...
interface BioChemEntityBase extends ThingBase {
	...
	associatedDisease?: SchemaValue<MedicalCondition | PropertyValue | URL | IdReference>;
	/** A BioChemEntity that is known to interact with this item. */
	bioChemInteraction?: SchemaValue<BioChemEntity | IdReference>;
	/** A similar BioChemEntity, e.g., obtained by fingerprint similarity algorithms. */
	bioChemSimilarity?: SchemaValue<BioChemEntity | IdReference>;
	/** A role played by the BioChemEntity within a biological context. */
	biologicalRole?: SchemaValue<DefinedTerm | IdReference>;
	...
	funding?: SchemaValue<Grant | IdReference>;
	/** Indicates a BioChemEntity that (in some sense) has this BioChemEntity as a part. */
	hasBioChemEntityPart?: SchemaValue<BioChemEntity | IdReference>;
	/** Molecular function performed by this BioChemEntity; please use PropertyValue if you want to include any evidence. */
	hasMolecularFunction?: SchemaValue<DefinedTerm | PropertyValue | URL | IdReference>;
	/** A common representation such as a protein sequence or chemical structure for this entity. For images use schema.org/image. */
	hasRepresentation?: SchemaValue<PropertyValue | Text | URL | IdReference>;
	/** Another BioChemEntity encoding by this one. */
	isEncodedByBioChemEntity?: SchemaValue<Gene | IdReference>;
	/** Biological process this BioChemEntity is involved in; please use PropertyValue if you want to include any evidence. */
	isInvolvedInBiologicalProcess?: SchemaValue<DefinedTerm | PropertyValue | URL | IdReference>;
	/** Subcellular location where this BioChemEntity is located; please use PropertyValue if you want to include any evidence. */
	isLocatedInSubcellularLocation?: SchemaValue<DefinedTerm | PropertyValue | URL | IdReference>;
	/** Indicates a BioChemEntity that is (in some sense) a part of this BioChemEntity. */
	isPartOfBioChemEntity?: SchemaValue<BioChemEntity | IdReference>;
	/** The taxonomic grouping of the organism that expresses, encodes, or in some way related to the BioChemEntity. */
	taxonomicRange?: SchemaValue<DefinedTerm | Taxon | Text | URL | IdReference>;
}
...
interface ChemicalSubstanceBase extends BioChemEntityBase {
	...
	chemicalComposition?: SchemaValue<Text>;
	/** A role played by the BioChemEntity within a chemical context. */
	chemicalRole?: SchemaValue<DefinedTerm | IdReference>;
	/** Intended use of the BioChemEntity by humans. */
	potentialUse?: SchemaValue<DefinedTerm | IdReference>;
}
...
interface ClaimBase extends CreativeWorkBase {
	...
	claimInterpreter?: SchemaValue<Organization | Person | IdReference>;
...
interface CreativeWorkBase extends ThingBase {
	...
	archivedAt?: SchemaValue<URL | WebPage | IdReference>;
	...
	expires?: SchemaValue<Date | DateTime>;
	/**
	...
	interpretedAsClaim?: SchemaValue<Claim | IdReference>;
	...
	size?: SchemaValue<DefinedTerm | QuantitativeValue | SizeSpecification | Text | IdReference>;
...
interface DatasetBase extends CreativeWorkBase {
	...
	variablesMeasured?: SchemaValue<PropertyValue | Text | IdReference>;
}
...
interface DemandBase extends ThingBase {
	...
	itemOffered?: SchemaValue<
		AggregateOffer | CreativeWork | Event | MenuItem | Product | Service | Trip | IdReference
	>;
...
export type DriveWheelConfigurationValue =
	...
	| DriveWheelConfigurationValueLeaf;
...
interface EducationalOccupationalProgramBase extends ThingBase {
	...
	programPrerequisites?: SchemaValue<
		AlignmentObject | Course | EducationalOccupationalCredential | Text | IdReference
	>;
...
export type EnergyEfficiencyEnumeration =
	| EnergyEfficiencyEnumerationLeaf
...
export type EnergyStarEnergyEfficiencyEnumeration =
	...
	| 'EnergyStarCertified'
	| EnergyStarEnergyEfficiencyEnumerationLeaf;
...
interface EntryPointBase extends ThingBase {
	...
	actionPlatform?: SchemaValue<DigitalPlatformEnumeration | Text | URL | IdReference>;
	/**
	 * An application that can complete the request.
	 *
...
interface GeneBase extends BioChemEntityBase {
	...
	alternativeOf?: SchemaValue<Gene | IdReference>;
	/** Another BioChemEntity encoded by this one. */
	encodesBioChemEntity?: SchemaValue<BioChemEntity | IdReference>;
	/** Tissue, organ, biological sample, etc in which activity of this gene has been observed experimentally. For example brain, digestive system. */
	expressedIn?: SchemaValue<
		AnatomicalStructure | AnatomicalSystem | BioChemEntity | DefinedTerm | IdReference
	>;
	/** A symbolic representation of a BioChemEntity. For example, a nucleotide sequence of a Gene or an amino acid sequence of a Protein. */
	hasBioPolymerSequence?: SchemaValue<Text>;
}
 ...
 * As a {@link https://schema.org/LocalBusiness LocalBusiness} it can be described as a {@link https://schema.org/provider provider} of one or more {@link https://schema.org/Service Service}(s).
 */
export type HomeAndConstructionBusiness =
	| HomeAndConstructionBusinessLeaf
	| Electrician
	| GeneralContractor
	| HousePainter
	| HVACBusiness
...
export type ItemList = HowToSection | HowToStep;
...
interface JobPostingBase extends ThingBase {
	...
	directApply?: SchemaValue<Boolean>;
	...
	experienceInPlaceOfEducation?: SchemaValue<Boolean>;
	/** Description of skills and experience needed for the position or Occupation. */
	experienceRequirements?: SchemaValue<OccupationalExperienceRequirements | Text | IdReference>;
	/** Organization or Person offering the job position. */
	hiringOrganization?: SchemaValue<Organization | Person | IdReference>;
...
export type MeasurementTypeEnumeration =
	| MeasurementTypeEnumerationLeaf
...
/** A media object, such as an image, video, or audio object embedded in a web page or a downloadable dataset, i.e. DataDownload. Note that a creative work may have many media objects associated with it on the same web page. For example, a page about a single song (MusicRecording) may have a music video (VideoObject), and a high and low bandwidth audio stream (2 {@link https://schema.org/AudioObject AudioObject}s). */
...
interface MediaReviewBase extends ReviewBase {
	...
	originalMediaContextDescription?: SchemaValue<Text>;
	...
	originalMediaLink?: SchemaValue<MediaObject | URL | WebPage | IdReference>;
}
...
interface MediaReviewItemBase extends CreativeWorkBase {
	...
	mediaItemAppearance?: SchemaValue<MediaObject | IdReference>;
}
...
export type MedicalObservationalStudyDesign =
	...
	| 'Registry'
	| MedicalObservationalStudyDesignLeaf;
...
interface MerchantReturnPolicyBase extends ThingBase {
	...
	applicableCountry?: SchemaValue<Country | Text | IdReference>;
	/** The type of return fees if the product is returned due to customer remorse. */
	customerRemorseReturnFees?: SchemaValue<ReturnFeesEnumeration | IdReference>;
	/** The method (from an enumeration) by which the customer obtains a return shipping label for a product returned due to customer remorse. */
	customerRemorseReturnLabelSource?: SchemaValue<ReturnLabelSourceEnumeration | IdReference>;
	...
	customerRemorseReturnShippingFeesAmount?: SchemaValue<MonetaryAmount | IdReference>;
	...
	itemDefectReturnFees?: SchemaValue<ReturnFeesEnumeration | IdReference>;
	/** The method (from an enumeration) by which the customer obtains a return shipping label for a defect product. */
	itemDefectReturnLabelSource?: SchemaValue<ReturnLabelSourceEnumeration | IdReference>;
	...
	itemDefectReturnShippingFeesAmount?: SchemaValue<MonetaryAmount | IdReference>;
	...
	merchantReturnDays?: SchemaValue<Date | DateTime | Integer>;
	...
	restockingFee?: SchemaValue<MonetaryAmount | Number | IdReference>;
	/** The type of return fees for purchased products (for any return reason). */
	returnFees?: SchemaValue<ReturnFeesEnumeration | IdReference>;
	/** The method (from an enumeration) by which the customer obtains a return shipping label for a product returned for any reason. */
	returnLabelSource?: SchemaValue<ReturnLabelSourceEnumeration | IdReference>;
	/** The type of return method offered, specified from an enumeration. */
	returnMethod?: SchemaValue<ReturnMethodEnumeration | IdReference>;
	...
	returnPolicyCountry?: SchemaValue<Country | Text | IdReference>;
	/** Seasonal override of a return policy. */
	returnPolicySeasonalOverride?: SchemaValue<MerchantReturnPolicySeasonalOverride | IdReference>;
	...
	returnShippingFeesAmount?: SchemaValue<MonetaryAmount | IdReference>;
}
...
interface MolecularEntityBase extends BioChemEntityBase {
	...
	inChI?: SchemaValue<Text>;
	/** InChIKey is a hashed version of the full InChI (using the SHA-256 algorithm). */
	inChIKey?: SchemaValue<Text>;
	/** Systematic method of naming chemical compounds as recommended by the International Union of Pure and Applied Chemistry (IUPAC). */
	iupacName?: SchemaValue<Text>;
	/** The empirical formula is the simplest whole number ratio of all the atoms in a molecule. */
	molecularFormula?: SchemaValue<Text>;
	/** This is the molecular weight of the entity being described, not of the parent. Units should be included in the form '<Number> <unit>', for example '12 amu' or as '<QuantitativeValue>. */
	molecularWeight?: SchemaValue<QuantitativeValue | Text | IdReference>;
	/** The monoisotopic mass is the sum of the masses of the atoms in a molecule using the unbound, ground-state, rest mass of the principal (most abundant) isotope for each element instead of the isotopic average mass. Please include the units in the form '<Number> <unit>', for example '770.230488 g/mol' or as '<QuantitativeValue>. */
	monoisotopicMolecularWeight?: SchemaValue<QuantitativeValue | Text | IdReference>;
	/** Intended use of the BioChemEntity by humans. */
	potentialUse?: SchemaValue<DefinedTerm | IdReference>;
	/** A specification in form of a line notation for describing the structure of chemical species using short ASCII strings. Double bond stereochemistry \ indicators may need to be escaped in the string in formats where the backslash is an escape character. */
	smiles?: SchemaValue<Text>;
}
...
interface ObservationBase extends ThingBase {
	...
	marginOfError?: SchemaValue<QuantitativeValue | IdReference>;
	...
	measuredValue?: SchemaValue<DataType | IdReference>;
...
interface OccupationalExperienceRequirementsBase extends ThingBase {
	...
	monthsOfExperience?: SchemaValue<Number>;
}
...
interface OfferBase extends ThingBase {
	...
	checkoutPageURLTemplate?: SchemaValue<Text>;
	/** The typical delay between the receipt of the order and the goods either leaving the warehouse or being prepared for pickup, in case the delivery method is on site pickup. */
	deliveryLeadTime?: SchemaValue<QuantitativeValue | IdReference>;
	/** The type(s) of customers for which the given offer is valid. */
	eligibleCustomerType?: SchemaValue<BusinessEntityType | IdReference>;
	...
	hasAdultConsideration?: SchemaValue<AdultOrientedEnumeration | IdReference>;
	/** A product measurement, for example the inseam of pants, the wheel size of a bicycle, or the gauge of a screw. Usually an exact measurement, but can also be a range of measurements for adjustable products, for example belts and ski bindings. */
	hasMeasurement?: SchemaValue<QuantitativeValue | IdReference>;
...
interface OfferShippingDetailsBase extends ThingBase {
	...
	shippingOrigin?: SchemaValue<DefinedRegion | IdReference>;
...
interface OrganizationBase extends ThingBase {
	 ...
	 */
	hasProductReturnPolicy?: SchemaValue<ProductReturnPolicy | IdReference>;
	/** The number of interactions for the CreativeWork using the WebSite or SoftwareApplication. The most specific child type of InteractionCounter should be used. */
	interactionStatistic?: SchemaValue<InteractionCounter | IdReference>;
...
interface PeopleAudienceBase extends AudienceBase {
	...
	suggestedAge?: SchemaValue<QuantitativeValue | IdReference>;
	/** The suggested gender of the intended person or audience, for example "male", "female", or "unisex". */
	suggestedGender?: SchemaValue<GenderType | Text | IdReference>;
	/** Maximum recommended age in years for the audience or user. */
	suggestedMaxAge?: SchemaValue<Number>;
	/** A suggested range of body measurements for the intended audience or person, for example inseam between 32 and 34 inches or height between 170 and 190 cm. Typically found on a size chart for wearable products. */
	suggestedMeasurement?: SchemaValue<QuantitativeValue | IdReference>;
...
interface PersonBase extends ThingBase {
	...
	hasOccupation?: SchemaValue<Occupation | IdReference>;
	/** Indicates an OfferCatalog listing for this Organization, Person, or Service. */
	hasOfferCatalog?: SchemaValue<OfferCatalog | IdReference>;
	/** Points-of-Sales operated by the organization or person. */
	hasPOS?: SchemaValue<Place | IdReference>;
...
interface PlayGameActionBase extends ConsumeActionBase {
	...
	gameAvailabilityType?: SchemaValue<GameAvailabilityEnumeration | Text | IdReference>;
}
...
export type PriceComponentTypeEnumeration =
	...
	| 'Subscription'
	| PriceComponentTypeEnumerationLeaf;
...
interface ProductBase extends ThingBase {
	...
	countryOfAssembly?: SchemaValue<Text>;
	...
	countryOfLastProcessing?: SchemaValue<Text>;
	/**
	 * The country of origin of something, including products as well as creative works such as movie and TV content.
	 *
	 * In the case of TV and movie, this would be the country of the principle offices of the production company or individual responsible for the movie. For other kinds of {@link https://schema.org/CreativeWork CreativeWork} it is difficult to provide fully general guidance, and properties such as {@link https://schema.org/contentLocation contentLocation} and {@link https://schema.org/locationCreated locationCreated} may be more applicable.
	 ...
	 */
	negativeNotes?: SchemaValue<ItemList | ListItem | Text | WebContent | IdReference>;
	 ...
	 */
	positiveNotes?: SchemaValue<ItemList | ListItem | Text | WebContent | IdReference>;
 ...
 */
export type ProductReturnEnumeration =
...
interface RecipeBase extends HowToBase {
	...
	recipeInstructions?: SchemaValue<ItemList | Text>;
	/** The quantity produced by the recipe (for example, number of people served, number of servings, etc). */
	recipeYield?: SchemaValue<Text>;
	/** Indicates a dietary restriction or guideline for which this recipe or menu item is suitable, e.g. diabetic, halal etc. */
	suitableForDiet?: SchemaValue<RestrictedDiet | IdReference>;
}
...
interface SellActionBase extends TradeActionBase {
	...
	buyer?: SchemaValue<Organization | Person | IdReference>;
	/**
	 * The warranty promise(s) included in the offer.
	 *
	 * @deprecated Consider using https://schema.org/warranty instead.
...
interface SizeSpecificationBase extends QualitativeValueBase {
	...
	sizeGroup?: SchemaValue<SizeGroupEnumeration | Text | IdReference>;
	/** The size system used to identify a product's size. Typically either a standard (for example, "GS1" or "ISO-EN13402"), country code (for example "US" or "JP"), or a measuring system (for example "Metric" or "Imperial"). */
	sizeSystem?: SchemaValue<SizeSystemEnumeration | Text | IdReference>;
	/** The age or age range for the intended audience or person, for example 3-12 months for infants, 1-5 years for toddlers. */
	suggestedAge?: SchemaValue<QuantitativeValue | IdReference>;
	/** The suggested gender of the intended person or audience, for example "male", "female", or "unisex". */
	suggestedGender?: SchemaValue<GenderType | Text | IdReference>;
...
interface StupidTypeBase extends ThingBase {
	...
	stupidProperty?: SchemaValue<QuantitativeValue | IdReference>;
}
...
interface TaxonBase extends ThingBase {
	...
	childTaxon?: SchemaValue<Taxon | Text | URL | IdReference>;
	/** A Defined Term contained in this term set. */
	hasDefinedTerm?: SchemaValue<DefinedTerm | IdReference>;
	/** Closest parent taxon of the taxon in question. */
	parentTaxon?: SchemaValue<Taxon | Text | URL | IdReference>;
	/** The taxonomic rank of this taxon given preferably as a URI from a controlled vocabulary – typically the ranks from TDWG TaxonRank ontology or equivalent Wikidata URIs. */
	taxonRank?: SchemaValue<PropertyValue | Text | URL | IdReference>;
}
