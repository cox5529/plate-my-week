<script lang="ts">
	...
	const author = recipe.externalAuthors ? recipe.externalAuthors[0].name : '';
	const categories = recipe.categories.join(', ');
</script>

<Card
	class="flex-grow-1 link-underline link-underline-opacity-0 link-underline-opacity-50-hover"
